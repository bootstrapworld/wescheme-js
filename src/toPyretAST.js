...
(function() {
  ...
  function makeLetExprFromCouple(couple) {
    return {
      ...
      kids: [{
        name: "let-expr",
        kids: [makeBindingFromSymbol(couple.first), equalsStx, couple.second.toPyret()],
        pos: couple.location
      }],
      pos: couple.location
    };
  ...
  function makeStructFromMembers(constructor, elts, loc) {
    ...
    return {
      ...
      kids: [{
        ...
        kids: [lBrackStx, {
          name: "constructor-modifier",
          kids: [],
          pos: blankLoc
        }, fakeArrayCall.toPyret(), colonStx].concat(listElts, [rBrackStx]),
        pos: blankLoc
      }],
      pos: loc
    };
  ...
  Program.prototype.toPyret = function() {
    console.log(this);
    throw "no toPyret() method defined";
  };
  // literals
  ...
  ifExpr.prototype.toPyret = function() {
    return {
      name: "if-expr",
      kids: [ifStx, this.predicate.toPyret(), colonStx, {
        name: "block",
        kids: [{
          name: "stmt",
  ...
  whenUnlessExpr.prototype.toPyret = function() {
    ...
    return {
      name: "when-expr",
      kids: [whenStx, this.predicate.toPyret(), colonStx, this.exprs.toPyret(), {
        name: "end",
        kids: [endStx],
        pos: this.location.end()
      }],
  ...
  condExpr.prototype.toPyret = function() {
    function makeIfPipeBranchfromClause(clause) {
      return {
        name: "if-pipe-branch",
        kids: [barStx, clause.first.toPyret(), thenStx, {
          name: "block",
    ...
    if (hasElse) {
      var elseClause = this.clauses[this.clauses.length - 1],
        otherwiseBlock = {
          name: "block",
          kids: [elseClause.second.toPyret()],
