...
Program.prototype.analyzeUses = function(pinfo, unusedEnv) {
  return pinfo;
};
defVar.prototype.analyzeUses = function(pinfo) {
  ...
  pinfo.env.extend((this.expr instanceof lambdaExpr) ?
    bf(this.name.val, false, this.expr.args.length, false, this.location) : new constantBinding(this.name.val, false, [], this.name.location));
