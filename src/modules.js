...
// mody-module-binding
export var mobyModuleBinding = new moduleBinding("moby", 'moby/moby', jsWorldModule.bindings.concat(worldStubModule.bindings));
...
export var topLevelModules = [topLevelModule, kernelMiscModule, jsWorldModule, worldModule];
export var knownCollections = ["bootstrap", "bootstrap2011", "bootstrap2012", "bootstrap2014", "bootstrap2015"];
export var knownModules = [kernelMiscModule, jsWorldModule, foreignModule, worldModule, worldStubModule, 
                          bootstrapTeachpack, bootstrapTeachpack2011, bootstrapTeachpack2012, bootstrapTeachpack2014, bootstrapTeachpack2015, 
                          bootstrapTiltTeachpack2012, bootstrapTiltTeachpack2014, bootstrapTiltTeachpack2015, 
                          cageTeachpack, cageTeachpack2011, cageTeachpack2012, cageTeachpack2014, 
                          functionTeachpack, functionTeachpack2011, functionTeachpack2012, functionTeachpack2014, functionTeachpack2015, 
                          locationModule, tiltModule, telephonyModule, netModule, mobyModuleBinding, parserModule, topLevelModule];